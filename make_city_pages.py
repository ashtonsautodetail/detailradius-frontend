...
<style>
  :root {{ --navy:#0F1116; --navy2:#1A2028; --cyan:#F5A623; --ink:#1e293b; --muted:#556074; }}
  * {{ box-sizing:border-box; margin:0; padding:0; }}
  ...
  .cta {{ display:inline-block; background:linear-gradient(135deg,#F5A623,#D97706); color:#fff; font-weight:800; font-size:17px; padding:15px 34px; border-radius:12px; text-decoration:none; box-shadow:0 14px 30px -8px rgba(217,119,6,.5); }}
